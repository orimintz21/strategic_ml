...
def objective(trial: optuna.trial.Trial) -> float:
    ...
    loss_fn = trial.suggest_categorical("loss_fn", ["hinge", "strategic_hinge", "mse", "bce"])
    ...
    delta = sml.gsc.LinearStrategicDelta(strategic_model=model, cost=cost_fn, cost_weight=COST_WEIGHT)
    ...
    model_suit = sml.ModelSuit(model=model, 
                                delta=delta,
                                loss_fn=loss_fn,
